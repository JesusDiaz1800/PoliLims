...
export default function ProductoTerminadoReportPage() {
  ...
  return (
    <div className="space-y-6">
      <Card>
        <CardHeader>
          <CardTitle>Certificado de Análisis (CoA) - Producto Terminado</CardTitle>
          <CardDescription>
            Seleccione un ensayo de producto terminado aprobado para generar su
            Certificado de Análisis individual.
          </CardDescription>
        </CardHeader>
        <CardContent>
