...
const demoEnsayos = [
    // --- July 2025 Data ---
    { id: 'LAB-07-01', tipo: 'Tubería HDPE', analista: 'Jesus Diaz', fecha: '2025-07-23', estado: 'Pendiente de Revisión' as const, producto: 'Tubería HDPE 90mm', lote: 'Lote-250722-PE1', meltIndexCalculado: null, meltIndexVariacion: null, densidadCalculada: null, negroHumoCalculado: null },
    { id: 'LAB-07-02', tipo: 'Tubería PP', analista: 'Antonia Figueroa', fecha: '2025-07-23', estado: 'En Análisis' as const, producto: 'Tubería PP-R 50mm', lote: 'Lote-250722-PP2', meltIndexCalculado: 0.28, meltIndexVariacion: 1.5, densidadCalculada: 0.905, negroHumoCalculado: null },
    ...
    { id: 'LAB-07-05', tipo: 'Tubería HDPE', analista: 'Bryan Vásquez', fecha: '2025-07-22', estado: 'Aprobado' as const, producto: 'Tubería HDPE 110mm', lote: 'Lote-250719-PE2', meltIndexCalculado: 0.25, meltIndexVariacion: 2.0, densidadCalculada: 0.960, negroHumoCalculado: 2.15 },
    { id: 'LAB-07-06', tipo: 'Tubería PP', analista: 'Jesus Diaz', fecha: '2025-07-21', estado: 'Rechazado' as const, producto: 'Tubería PP-R 25mm', lote: 'Lote-250718-PP3', meltIndexCalculado: 0.35, meltIndexVariacion: 15.3, densidadCalculada: 0.910, negroHumoCalculado: null },
    ...
    { id: 'LAB-07-08', tipo: 'Tubería HDPE', analista: 'Maximiliano Miranda', fecha: '2025-07-20', estado: 'Aprobado' as const, producto: 'Tubería HDPE 63mm', lote: 'Lote-250715-PE3', meltIndexCalculado: 0.23, meltIndexVariacion: 1.8, densidadCalculada: 0.958, negroHumoCalculado: 2.2 },
    { id: 'LAB-07-09', tipo: 'Tubería HDPE', analista: 'Jesus Diaz', fecha: '2025-07-20', estado: 'En Análisis' as const, producto: 'Tubería HDPE 200mm', lote: 'Lote-250714-PE4', meltIndexCalculado: 0.26, meltIndexVariacion: 0.5, densidadCalculada: 0.959, negroHumoCalculado: 2.22 },
    ...
    { id: 'LAB-07-11', tipo: 'Tubería PP', analista: 'Bryan Vásquez', fecha: '2025-07-19', estado: 'Aprobado' as const, producto: 'Tubería PP-R 32mm', lote: 'Lote-250710-PP1', meltIndexCalculado: 0.29, meltIndexVariacion: 2.1, densidadCalculada: 0.903, negroHumoCalculado: null },
    { id: 'LAB-07-12', tipo: 'Tubería HDPE', analista: 'Antonia Figueroa', fecha: '2025-07-18', estado: 'Aprobado' as const, producto: 'Tubería HDPE 90mm', lote: 'Lote-250708-PE1', meltIndexCalculado: 0.24, meltIndexVariacion: 1.7, densidadCalculada: 0.958, negroHumoCalculado: 2.28 },
    ...
    { id: 'LAB-07-14', tipo: 'Tubería HDPE', analista: 'Jesus Diaz', fecha: '2025-07-17', estado: 'En Progreso' as const, producto: 'Tubería HDPE 110mm', lote: 'Lote-250702-PE2', meltIndexCalculado: 0.255, meltIndexVariacion: 2.5, densidadCalculada: 0.959, negroHumoCalculado: 2.18 },
    { id: 'LAB-07-15', tipo: 'Tubería PP', analista: 'Bryan Vásquez', fecha: '2025-07-16', estado: 'Pendiente de Revisión' as const, producto: 'Tubería PP-R 50mm', lote: 'Lote-250701-PP2', meltIndexCalculado: null, meltIndexVariacion: null, densidadCalculada: null, negroHumoCalculado: null },
    { id: 'LAB-07-16', tipo: 'Tubería HDPE', analista: 'Jesus Diaz', fecha: '2025-07-15', estado: 'Aprobado' as const, producto: 'Tubería HDPE 63mm', lote: 'Lote-250715-PE3', meltIndexCalculado: 0.235, meltIndexVariacion: 2.2, densidadCalculada: 0.958, negroHumoCalculado: 2.21 },
    { id: 'LAB-07-17', tipo: 'Tubería PP', analista: 'Antonia Figueroa', fecha: '2025-07-14', estado: 'Aprobado' as const, producto: 'Tubería PP-R 32mm', lote: 'Lote-250710-PP1', meltIndexCalculado: 0.285, meltIndexVariacion: 1.9, densidadCalculada: 0.902, negroHumoCalculado: null },
    { id: 'LAB-07-18', tipo: 'Tubería HDPE', analista: 'Bryan Vásquez', fecha: '2025-07-13', estado: 'Aprobado' as const, producto: 'Tubería HDPE 90mm', lote: 'Lote-250708-PE1', meltIndexCalculado: 0.245, meltIndexVariacion: 2.1, densidadCalculada: 0.957, negroHumoCalculado: 2.29 },
    ...
    { id: 'LAB-07-20', tipo: 'Tubería HDPE', analista: 'Robinson Córdova', fecha: '2025-07-11', estado: 'En Progreso' as const, producto: 'Tubería HDPE 110mm', lote: 'Lote-250702-PE2', meltIndexCalculado: 0.25, meltIndexVariacion: 2.0, densidadCalculada: 0.960, negroHumoCalculado: 2.15 },
    { id: 'LAB-07-21', tipo: 'Tubería PP', analista: 'Jesus Diaz', fecha: '2025-07-10', estado: 'Pendiente de Revisión' as const, producto: 'Tubería PP-R 50mm', lote: 'Lote-250701-PP2', meltIndexCalculado: null, meltIndexVariacion: null, densidadCalculada: null, negroHumoCalculado: null },
    ...
    { id: 'LAB-07-23', tipo: 'Tubería HDPE', analista: 'Bryan Vásquez', fecha: '2025-07-08', estado: 'Aprobado' as const, producto: 'Tubería HDPE 200mm', lote: 'Lote-250705-PE4', meltIndexCalculado: 0.26, meltIndexVariacion: 0.8, densidadCalculada: 0.959, negroHumoCalculado: 2.22 },
    ...
    { id: 'LAB-07-25', tipo: 'Tubería PP', analista: 'Robinson Córdova', fecha: '2025-07-06', estado: 'Rechazado' as const, producto: 'Tubería PP-R 25mm', lote: 'Lote-250705-PP3', meltIndexCalculado: 0.36, meltIndexVariacion: 18.2, densidadCalculada: 0.911, negroHumoCalculado: null },
    { id: 'LAB-07-26', tipo: 'Tubería HDPE', analista: 'Jesus Diaz', fecha: '2025-07-05', estado: 'Aprobado' as const, producto: 'Tubería HDPE 63mm', lote: 'Lote-250705-PE3', meltIndexCalculado: 0.23, meltIndexVariacion: 1.5, densidadCalculada: 0.958, negroHumoCalculado: 2.2 },
    ...
    { id: 'LAB-07-28', tipo: 'Tubería PP', analista: 'Bryan Vásquez', fecha: '2025-07-03', estado: 'Aprobado' as const, producto: 'Tubería PP-R 32mm', lote: 'Lote-250703-PP1', meltIndexCalculado: 0.29, meltIndexVariacion: 2.3, densidadCalculada: 0.903, negroHumoCalculado: null },
    { id: 'LAB-07-29', tipo: 'Tubería HDPE', analista: 'Maximiliano Miranda', fecha: '2025-07-02', estado: 'En Análisis' as const, producto: 'Tubería HDPE 90mm', lote: 'Lote-250702-PE1', meltIndexCalculado: 0.24, meltIndexVariacion: 1.9, densidadCalculada: 0.958, negroHumoCalculado: 2.25 },
