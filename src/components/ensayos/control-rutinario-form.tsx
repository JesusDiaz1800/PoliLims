...
export function ControlRutinarioForm({ inspectores }: ControlRutinarioFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
       ...
       <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="space-y-2">
            ...
            <Input id="marca" placeholder="Marca del producto"/>
        </div>
        <div className="space-y-2">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-xl">Mediciones</CardTitle>
        </CardHeader>
       ...
       <Card>
        <CardHeader>
          <CardTitle className="text-xl">Controles Adicionales</CardTitle>
        </CardHeader>
        <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="space-y-2">
              <Label htmlFor="color_tuberia">Color de Tubería</Label>
              <Input id="color_tuberia" placeholder="Ej: Negro"/>
          </div>
          <div className="space-y-2">
              <Label htmlFor="color_linea">Color Línea de Identificación</Label>
              <Input id="color_linea" placeholder="Ej: Azul"/>
          </div>
          <div className="space-y-2">
              <Label htmlFor="contraccion">Contracción</Label>
              <Input id="contraccion" placeholder="Resultado del ensayo"/>
          </div>
          <div className="space-y-2">
      ...
      <div className="space-y-2">
        ...
        <Textarea
          id="observaciones"
          placeholder="Añada cualquier nota sobre la calidad visual o al tacto..."
          rows={4}
        />
      </div>
