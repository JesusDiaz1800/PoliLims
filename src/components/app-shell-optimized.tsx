    ...
    <div className="flex min-h-screen w-full">
       ...
       >
        <SidebarContent>
             ...
             <Logo variant="white" className="w-40 group-data-[state=collapsed]/sidebar-wrapper:w-9 group-data-[state=collapsed]/sidebar-wrapper:px-0" />
           </div>
      ...
      <div className="flex flex-col flex-1 h-screen overflow-hidden">
        ...
        {!isDashboard && (
          <header
            className="sticky top-0 z-30 flex h-16 items-center border-b bg-background/80 backdrop-blur-sm px-4 sm:px-6"
            role="banner"
          >
