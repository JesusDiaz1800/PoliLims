    ...
    <Form form={form} onSubmit={form.handleSubmit(onSubmit)}>
      <div className="space-y-4 pr-3">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <FormField control={form.control} name="tipo" render={({ field }) => (<FormItem><FormLabel>Tipo de Proveedor</FormLabel><FormControl><Input placeholder="Ej: Calibración, Materia Prima, Reactivos" {...field} /></FormControl><FormMessage /></FormItem>)}/>
            ...
            <FormField control={form.control} name="certificacionesISO" render={({ field }) => (<FormItem className="md:col-span-2"><FormLabel>Certificaciones ISO (separadas por coma)</FormLabel><FormControl><Input placeholder="Ej: ISO 9001, ISO 17025" {...field} /></FormControl><FormMessage /></FormItem>)}/>
            <FormField control={form.control} name="contratoUrl" render={({ field }) => (<FormItem className="md:col-span-2"><FormLabel>URL del Contrato (Opcional)</FormLabel><FormControl><Input placeholder="https://ejemplo.com/contrato.pdf" {...field} /></FormControl><FormMessage /></FormItem>)}/>
            <FormField control={form.control} name="observaciones" render={({ field }) => (<FormItem className="md:col-span-2"><FormLabel>Observaciones</FormLabel><FormControl><Textarea placeholder="Añada cualquier nota relevante sobre el proveedor..." {...field} /></FormControl><FormMessage /></FormItem>)}/>
        </div>
