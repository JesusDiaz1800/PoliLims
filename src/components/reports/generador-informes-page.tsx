...
import { generateReportAction, generateProductCertificateAction } from '@/app/(app)/reports/generador/actions';
...
export default function GeneradorInformesPageContent() {
