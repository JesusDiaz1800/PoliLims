        ...
        <div className="flex min-h-screen w-full bg-background">
            <Sidebar>
                ...
                <SidebarFooter>
                    ...
                    <div className="flex items-center gap-3 px-2 group-data-[state=collapsed]/sidebar-wrapper:justify-center group-data-[state=collapsed]/sidebar-wrapper:p-0 group-data-[state=collapsed]/sidebar-wrapper:py-2">
