...
const demoRegistros: Registro[] = [
    ...
    { id: 'CTRL-005', fecha: '18-07-2025', hora: '16:20', inspector: 'Elias Ibañez', maquinista: 'JORGE GARCÍA', maquina: 'PE1', producto: 'Tubería HDPE 90mm PN-16 SDR-11', marca: 'POLIFUSIÓN S.A.', diametro: 90.2, espesor_min: 8.3, espesor_max: 8.4, largo: 1000, peso_muestra: 2210, peso_kg_m: 2.21, ovalidad: 0.4, resultado: 'Conforme', enviado_lab: true },
    { id: 'CTRL-006', fecha: '18-07-2025', hora: '17:00', inspector: 'Cristian Montellano', maquinista: 'SEBASTIÁN SERRA', maquina: 'PP1', producto: 'Tubería PP-R 20mm PN-20', marca: 'SMART PIPES SpA', diametro: 20.1, espesor_min: 3.4, espesor_max: 3.5, largo: 1000, peso_muestra: 210, peso_kg_m: 0.21, ovalidad: 0.1, resultado: 'Conforme', enviado_lab: true },
];
...
const demoEnsayos: Ensayo[] = [
    ...
    { id: 'LAB-07-05', id_muestra: 'CTRL-002', tipo: 'Tubería HDPE', analista: 'Bryan Vásquez', fecha: '22-07-2025', estado: 'Aprobado', producto: 'Tubería HDPE 110mm PN-10 SDR-17', lote: 'Lote-250719-PE2', meltIndexCalculado: 0.25, meltIndexVariacion: 2.0, densidadCalculada: 0.960, negroHumoCalculado: 2.15, tio_tiempo: 35, resistencia_traccion: 24.1, elongacion_rotura: 650, dispersion_nh: 'A1', fecha_ingreso: '19-07-2025', hora: '11:15', inspector: 'Cristian Montellano', maquina: 'PE2', created_by: 'cmontellano', created_at: '2025-07-19T11:15:00Z', modified_by: 'vlutz', modified_at: '2025-07-22T17:00:00Z', assigned_to: 'Bryan Vásquez' },
    // --- June 2025 Data ---
    { id: 'LAB-06-01', id_muestra: 'CTRL-005', tipo: 'Tubería HDPE', analista: 'Jesus Diaz', fecha: '20-06-2025', estado: 'Aprobado', producto: 'Tubería HDPE 90mm PN-16 SDR-11', lote: 'Lote-250618-PE1', meltIndexCalculado: 0.248, meltIndexVariacion: 1.8, densidadCalculada: 0.959, negroHumoCalculado: 2.2, tio_tiempo: 30, resistencia_traccion: 23.9, elongacion_rotura: 630, dispersion_nh: 'A1', fecha_ingreso: '18-06-2025', created_by: 'eibanez', created_at: '2025-06-18T16:20:00Z', modified_by: 'vlutz', modified_at: '2025-06-20T17:00:00Z', assigned_to: 'Jesus Diaz' },
    { id: 'LAB-06-02', tipo: 'Materia Prima', analista: 'Maximiliano Miranda', fecha: '15-06-2025', estado: 'Rechazado', producto: 'RP100R', lote: '556789', proveedor: 'REPSOL', orden_compra: '170615', melt_index_reportado: '0.25', meltIndexCalculado: 0.35, meltIndexVariacion: 40, densidad_liquido: '0.955', densidadCalculada: 0.954, negroHumoCalculado: 2.1, tio_tiempo: 15, dsc_punto_fusion: 130, comentarios_aprobacion: 'Variación de Melt Index excede el límite del 30%.', created_by: 'mmiranda', created_at: '2025-06-14T10:00:00Z', modified_by: 'vlutz', modified_at: '2025-06-15T16:00:00Z', assigned_to: 'Maximiliano Miranda' },
     { id: 'LAB-06-03', id_muestra: 'CTRL-006', tipo: 'Tubería PP', analista: 'Antonia Figueroa', fecha: '20-06-2025', estado: 'Aprobado', producto: 'Tubería PP-R 20mm PN-20', lote: 'Lote-250618-PP1', meltIndexCalculado: 0.31, meltIndexVariacion: 2.5, densidadCalculada: 0.908, negroHumoCalculado: null, fvTotalPorcentaje: 19.5, fvIntermediaPorcentaje: 21.2, fecha_ingreso: '18-06-2025', hora: '17:00', inspector: 'Cristian Montellano', maquina: 'PP1', created_by: 'cmontellano', created_at: '2025-06-18T17:00:00Z', modified_by: 'afigueroa', modified_at: '2025-06-20T12:00:00Z', assigned_to: 'Antonia Figueroa' },
    // --- May 2025 Data ---
    { id: 'LAB-05-01', tipo: 'Tubería HDPE', analista: 'Bryan Vásquez', fecha: '18-05-2025', estado: 'Aprobado', producto: 'Tubería HDPE 63mm PN-16 SDR-11', lote: 'Lote-250516-PE3', meltIndexCalculado: 0.255, meltIndexVariacion: 2.0, densidadCalculada: 0.961, negroHumoCalculado: 2.25, tio_tiempo: 33, resistencia_traccion: 24.5, elongacion_rotura: 640, dispersion_nh: 'A1', fecha_ingreso: '16-05-2025', created_by: 'lparada', created_at: '2025-05-16T09:05:00Z', modified_by: 'vlutz', modified_at: '2025-05-18T15:00:00Z', assigned_to: 'Bryan Vásquez' }
];
...
const demoControles: ControlEvento[] = [
    { id: 'CE-001', equipoId: 'EQ-01', fecha: '15-01-2025', tipo: 'Calibración', responsable: 'Servicio Externo Trescal', observaciones: 'Calibración anual completa según procedimiento XYZ.', certificadoUrl: '#' },
