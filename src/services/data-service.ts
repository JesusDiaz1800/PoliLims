...
let demoEnsayos: Ensayo[] = [
    ...
    { id: 'LAB-05-02', tipo: 'Materia Prima', analista: 'Antonia Figueroa', fecha: '15-05-2025', estado: 'Aprobado', producto: 'HE3490LS', lote: '1325110', proveedor: 'BOREALIS CO.', orden_compra: '170502', melt_index_reportado: '0.23', meltIndexCalculado: 0.235, meltIndexVariacion: 2.17, densidadCalculada: 0.959, negroHumoCalculado: 2.15, tio_tiempo: 48 },
    
    // --- April 2025 Data ---
    { id: 'LAB-04-01', tipo: 'Tubería HDPE', analista: 'Robinson Córdova', fecha: '28-04-2025', estado: 'Aprobado', producto: 'Tubería HDPE 63mm PN-16 SDR-11', lote: 'Lote-250425-PE3', meltIndexCalculado: 0.25, meltIndexVariacion: 2.5, densidadCalculada: 0.956, negroHumoCalculado: 2.4, tio_tiempo: 30, resistencia_traccion: 23.0, elongacion_rotura: 605, dispersion_nh: 'A1', fecha_ingreso: '25-04-2025', hora: '08:30', inspector: 'Luis Parada', maquina: 'PE3' },
    { id: 'LAB-04-02', tipo: 'Reprocesado', analista: 'Jesus Diaz', fecha: '20-04-2025', estado: 'Pendiente de Revisión', producto: 'Reprocesado Lote RP-0420', lote: 'RP-0420', meltIndexCalculado: 0.30, meltIndexVariacion: 4.0, densidadCalculada: 0.954, negroHumoCalculado: 2.4, tio_tiempo: 19 },
];
