...
let demoEnsayos: Ensayo[] = [
    ...
    { id: 'LAB-07-05', id_muestra: 'CTRL-002', tipo: 'Tubería HDPE', analista: 'Jesus Diaz', fecha: '24-07-2025', estado: 'Aprobado', producto: 'Tubería HDPE 110mm PN-10 SDR-17', lote: 'Lote-250720-PE2', meltIndexCalculado: 0.25, meltIndexVariacion: 1.8, densidadCalculada: 0.959, negroHumoCalculado: 2.3, tio_tiempo: 28, resistencia_traccion: 24.1, elongacion_rotura: 620, dispersion_nh: 'A1', fecha_ingreso: '20-07-2025', hora: '11:15', inspector: 'Cristian Montellano', maquina: 'PE2', created_by: 'cmontellano', created_at: '2025-07-20T11:15:00Z', modified_by: 'vlutz', modified_at: '2025-07-24T10:00:00Z', assigned_to: 'Jesus Diaz' },
    // --- June 2025 Data ---
    { id: 'LAB-06-01', tipo: 'Tubería HDPE', analista: 'Antonia Figueroa', fecha: '18-06-2025', estado: 'Aprobado', producto: 'Tubería HDPE 90mm PN-16 SDR-11', lote: 'Lote-250615-PE1', meltIndexCalculado: 0.24, meltIndexVariacion: 1.5, densidadCalculada: 0.957, negroHumoCalculado: 2.1, tio_tiempo: 26, resistencia_traccion: 23.8, elongacion_rotura: 615, dispersion_nh: 'A1', fecha_ingreso: '15-06-2025', hora: '09:00', inspector: 'Elias Ibañez', maquina: 'PE1', created_by: 'eibanez', created_at: '2025-06-15T09:00:00Z', modified_by: 'vlutz', modified_at: '2025-06-18T14:00:00Z', assigned_to: 'Antonia Figueroa' },
    { id: 'LAB-06-02', tipo: 'Tubería HDPE', analista: 'Jesus Diaz', fecha: '19-06-2025', estado: 'Aprobado', producto: 'Tubería HDPE 90mm PN-16 SDR-11', lote: 'Lote-250616-PE1', meltIndexCalculado: 0.242, meltIndexVariacion: 1.7, densidadCalculada: 0.958, negroHumoCalculado: 2.2, tio_tiempo: 27, resistencia_traccion: 23.9, elongacion_rotura: 618, dispersion_nh: 'A2', fecha_ingreso: '16-06-2025', hora: '10:00', inspector: 'Elias Ibañez', maquina: 'PE1', created_by: 'eibanez', created_at: '2025-06-16T10:00:00Z', modified_by: 'vlutz', modified_at: '2025-06-19T15:00:00Z', assigned_to: 'Jesus Diaz' },
    { id: 'LAB-06-03', tipo: 'Materia Prima', analista: 'Robinson Córdova', fecha: '12-06-2025', estado: 'Rechazado', producto: 'PPR-Y40', lote: 'XYZ-987', proveedor: 'GENERICO', orden_compra: '170601', melt_index_reportado: '0.3', meltIndexCalculado: 0.45, meltIndexVariacion: 50, densidad_liquido: '0.901', densidadCalculada: 0.901, created_by: 'rcordova', created_at: '2025-06-10T10:00:00Z', modified_by: 'vlutz', modified_at: '2025-06-12T11:00:00Z', assigned_to: 'Robinson Córdova' },

    // --- May 2025 Data ---
    { id: 'LAB-05-01', tipo: 'Tubería PP', analista: 'Jesus Diaz', fecha: '25-05-2025', estado: 'Aprobado', producto: 'Tubería PP-R 25mm PN-20', lote: 'Lote-250522-PP3', meltIndexCalculado: 0.29, meltIndexVariacion: 2.0, densidadCalculada: 0.903, fvTotalPorcentaje: 17.8, fvIntermediaPorcentaje: 19.5, fecha_ingreso: '22-05-2025', hora: '11:00', inspector: 'Daniel Palma', maquina: 'PP3', created_by: 'dpalma', created_at: '2025-05-22T11:00:00Z', modified_by: 'vlutz', modified_at: '2025-05-25T13:00:00Z', assigned_to: 'Jesus Diaz' },
    { id: 'LAB-05-02', tipo: 'Materia Prima', analista: 'Antonia Figueroa', fecha: '15-05-2025', estado: 'Aprobado', producto: 'HE3490LS', lote: '1325110', proveedor: 'BOREALIS CO.', orden_compra: '170502', melt_index_reportado: '0.23', meltIndexCalculado: 0.235, meltIndexVariacion: 2.17, densidadCalculada: 0.959, negroHumoCalculado: 2.15, tio_tiempo: 48, created_by: 'afigueroa', created_at: '2025-05-14T12:00:00Z', modified_by: 'vlutz', modified_at: '2025-05-15T18:00:00Z', assigned_to: 'Antonia Figueroa' },
    
    // --- April 2025 Data ---
    { id: 'LAB-04-01', tipo: 'Tubería HDPE', analista: 'Robinson Córdova', fecha: '28-04-2025', estado: 'Aprobado', producto: 'Tubería HDPE 63mm PN-16 SDR-11', lote: 'Lote-250425-PE3', meltIndexCalculado: 0.25, meltIndexVariacion: 2.5, densidadCalculada: 0.956, negroHumoCalculado: 2.4, tio_tiempo: 30, resistencia_traccion: 23.0, elongacion_rotura: 605, dispersion_nh: 'A1', fecha_ingreso: '25-04-2025', hora: '08:30', inspector: 'Luis Parada', maquina: 'PE3', created_by: 'lparada', created_at: '2025-04-25T08:30:00Z', modified_by: 'vlutz', modified_at: '2025-04-28T10:00:00Z', assigned_to: 'Robinson Córdova' },
    { id: 'LAB-04-02', tipo: 'Reprocesado', analista: 'Jesus Diaz', fecha: '20-04-2025', estado: 'Pendiente de Revisión', producto: 'Reprocesado Lote RP-0420', lote: 'RP-0420', meltIndexCalculado: 0.30, meltIndexVariacion: 4.0, densidadCalculada: 0.954, negroHumoCalculado: 2.4, tio_tiempo: 19, created_by: 'jdiaz', created_at: '2025-04-20T09:00:00Z', modified_by: 'jdiaz', modified_at: '2025-04-20T12:00:00Z', assigned_to: 'Jesus Diaz' },
];
...
let recentActivityData: RecentActivity[] = [
    ...
    { id: 'ACT-5', user: 'Cristian Montellano', action: 'registró un control para Tubería HDPE 110mm', timestamp: new Date(new Date('2025-07-20T11:15:00Z')).toISOString() },
];


const demoEquipos: Equipo[] = [
    { id: 'EQ-01', nombre: 'Espectrómetro FTIR', estado: 'Activo', marca: 'PerkinElmer', modelo: 'Spectrum Two', numero_serie: 'FTIR-9876', fecha_puesta_marcha: '10-01-2022', proxima_calibracion: '15-01-2026', ubicacion: 'Mesón Central, Lab. Principal', criticidad: 'Alta', fotoUrl: 'https://placehold.co/400x400.png', observaciones: 'Equipo sensible a vibraciones.', ensayos_asociados: ['dsc', 'tio'], manual_url: '#', procedimiento_url: '#' },
    { id: 'EQ-02', nombre: 'Prensa de Impacto', estado: 'En Mantenimiento', marca: 'CEAST', modelo: '9050', numero_serie: 'IMP-5432', fecha_puesta_marcha: '05-03-2021', proxima_calibracion: '20-12-2025', ubicacion: 'Área de Ensayos Mecánicos', criticidad: 'Media', fotoUrl: 'https://placehold.co/400x400.png' },
    { id: 'EQ-03', nombre: 'Máquina de Tracción', estado: 'Requiere Calibración', marca: 'Instron', modelo: '5967', numero_serie: 'TRAC-1234', fecha_puesta_marcha: '12-06-2020', proxima_calibracion: '01-08-2025', ubicacion: 'Área de Ensayos Mecánicos', criticidad: 'Alta', fotoUrl: 'https://placehold.co/400x400.png', ensayos_asociados: ['traccion'] },
    { id: 'EQ-04', nombre: 'Plastómetro MFI', estado: 'Activo', marca: 'CEAST', modelo: 'Melt Flow 2000', numero_serie: 'MFI-3344', fecha_puesta_marcha: '20-02-2023', proxima_calibracion: '01-03-2026', ubicacion: 'Mesón Central, Lab. Principal', criticidad: 'Media', fotoUrl: 'https://placehold.co/400x400.png', ensayos_asociados: ['melt_index'] },
    { id: 'EQ-05', nombre: 'Balanza Analítica', estado: 'Activo', marca: 'Mettler Toledo', modelo: 'MS-TS', numero_serie: 'BAL-5566', fecha_puesta_marcha: '01-09-2019', proxima_calibracion: '10-08-2025', ubicacion: 'Sala de Pesaje', criticidad: 'Alta', fotoUrl: 'https://placehold.co/400x400.png', ensayos_asociados: ['densidad', 'negro_humo', 'fibra_vidrio', 'humedad', 'cenizas'] },
    { id: 'EQ-06', nombre: 'Mufla', estado: 'Activo', marca: 'Nabertherm', modelo: 'L 5/11', numero_serie: 'MUF-7788', fecha_puesta_marcha: '18-07-2018', proxima_calibracion: 'N/A', ubicacion: 'Área de Hornos', criticidad: 'Media', fotoUrl: 'https://placehold.co/400x400.png', ensayos_asociados: ['negro_humo', 'fibra_vidrio', 'cenizas'] },
    { id: 'EQ-07', nombre: 'Termómetro Ambiental', estado: 'Inactivo', marca: 'Testo', modelo: '174H', numero_serie: 'TERM-9900', fecha_puesta_marcha: '30-11-2022', proxima_calibracion: '30-11-2025', ubicacion: 'Sala de Muestras', criticidad: 'Baja', fotoUrl: 'https://placehold.co/400x400.png' },
];
...
export async function getInitialData() {
    ...
    const updatedEquipos = demoEquipos.map(equipo => {
        if (equipo.estado === 'Activo' && equipo.proxima_calibracion !== 'N/A' && isPast(parse(equipo.proxima_calibracion, 'dd-MM-yyyy', new Date()))) {
